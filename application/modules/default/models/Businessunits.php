...
class Default_Model_Businessunits extends Zend_Db_Table_Abstract
{
    ...
    public function getBusinessUnitsData($sort, $by, $pageNo, $perPage, $searchQuery)
    {
        ...
        $businessunitsdata = $this->select()
            ...
            ->from(array('b' => 'main_businessunits'), array('id' => 'b.id', 'isactive' => 'b.isactive', 'unitcode' => 'b.unitcode', 'address1' => 'b.address1', 'unitname' => 'b.unitname', 'startdate' => 'DATE_FORMAT(b.startdate,"' . DATEFORMAT_MYSQL . '")'))
            ->joinLeft(array('u' => 'main_users'), 'b.unithead=u.id', array('unithead' => 'u.userfullname'))
    ...
    public function getGrid($sort, $by, $perPage, $pageNo, $searchData, $call, $dashboardcall, $a = '', $b = '', $c = '', $d = '')
    {
        ...
        $tableFields = array('action' => 'Action', 'unitname' => 'Name', 'unitcode' => 'Code', 'startdate' => 'Started On', 'unithead' => 'Unit Head', 'address1' => 'Street Address', 'city' => 'City', 'state' => 'State', 'country' => 'Country', 'timezone' => 'Time zone');
