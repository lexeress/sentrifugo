 ...
 */
class Tree_NodeBuilder implements Tree_NodeBuilderInterface
{
    /**
     * @var NodeInterface[]
     */
     ...
     */
    public function __construct(Tree_NodeInterface $node = null)
    {
     ...
     * {@inheritdoc}
     */
    public function setNode(Tree_NodeInterface $node)
    {
        $this
            ->emptyStack()
            ->pushNode($node)
    ...
    private function pushNode(Tree_NodeInterface $node)
    {
