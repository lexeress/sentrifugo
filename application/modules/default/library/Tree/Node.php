 ...
 * Class Node
 */
class Tree_Node implements Tree_NodeInterface
{
    /**
     * @var mixed
     */
    ...
    /**
     * @param mixed $value
     * @param Tree_NodeInterface[] $children
     */
     ...
     * {@inheritdoc}
     */
    public function addChild(Tree_NodeInterface $child)
    {
     ...
     * {@inheritdoc}
     */
    public function removeChild(Tree_NodeInterface $child)
    {
     ...
     * {@inheritdoc}
     */
    public function setParent(Tree_NodeInterface $parent = null)
    {
        $this->parent = $parent;
    }
     ...
     * {@inheritdoc}
     */
    public function accept(Tree_Visitor $visitor)
    {
