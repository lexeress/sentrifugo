...
CREATE TABLE `main_empcommunicationdetails` (
  ...
  `work_streetaddress` varchar(200) DEFAULT NULL,
  `work_country` bigint(20) DEFAULT NULL,
  `work_state` bigint(20) DEFAULT NULL,
  `work_city` bigint(20) DEFAULT NULL,
  `work_pincode` varchar(15) DEFAULT NULL,
